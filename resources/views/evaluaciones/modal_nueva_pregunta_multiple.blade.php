    ...
    <div class="modal-content">
        <div class="modal-header" style="background-color: #636366">
            ...
            <h4 class="modal-title" style="color: white">
                <strong>Nueva Pregunta de selección múltiple</strong>
            </h4>
        </div>
                                    ...
                                    <td width="5%">
                                        <div class="smart-form">
                                            <label class="checkbox">
                                                <input type="checkbox" name="checkbox" value="A" style="margin-left:0px">
                                                <i></i></label></div>
                                    </td>
                                </tr>
                                <tr class="danger">
                                    ...
                                    <td>
                                        <div class="smart-form">
                                            <label class="checkbox">
                                                <input type="checkbox" name="checkbox" value="B" style="margin-left:0px">
                                                <i></i></label></div>
                                    </td>
                                </tr>
                                <tr class="warning">
                                    ...
                                    <td>
                                        <div class="smart-form">
                                            <label class="checkbox">
                                                <input type="checkbox" name="checkbox" value="C" style="margin-left:0px">
                                                <i></i></label></div>
                                    </td>
                                </tr>
                                <tr class="info">
                                    ...
                                    <td>
                                        <div class="smart-form">
                                            <label class="checkbox">
                                                <input type="checkbox" name="checkbox" value="D" style="margin-left:0px">
                                                <i></i></label></div>
                                    </td>
                                </tr>
                                <tr class="success">
                                    ...
                                    <td>
                                        <div class="smart-form">
                                            <label class="checkbox">
                                                <input type="checkbox" name="checkbox" value="E" style="margin-left:0px">
                                                <i></i></label></div>
                                    </td>
                                </tr>
                                </tbody>
