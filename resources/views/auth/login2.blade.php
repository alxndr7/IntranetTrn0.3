...
<header id="header">
    ...
    <div id="logo-group">
        <span id="logo"> <img src="{{ asset('img/logo-transaltisa.png')}}" alt="TRANSALTISA"> </span>
    </div>
                    ...
                    <div class="col-sm-12">
                        <div id="myCarousel" class="carousel fade" style="margin-bottom: 20px;">
                            <div class="air air-bottom-right padding-10">
                                <a href="" class="btn txt-color-white bg-color-teal btn-sm"><i class="fa fa-check"></i> Siguenos</a>&#xA0;
                                <a href="" class="btn txt-color-white bg-color-pinkDark btn-sm"><i class="fa fa-link"></i> Únete</a>
                            </div>
                            <div class="air air-top-left padding-10">
                                <h4 class="txt-color-white font-md">INTRANET Transaltisa, 2018</h4>
                            </div>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item active">
                                    <img src="{{ asset('img/00-main-02.jpg')}}" alt="demo user">
                                </div>
                                <!-- Slide 2 -->
                                <div class="item">
                        ...
                        <fieldset>
                            <section>
                                ...
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    <input type="text" name="usu_usuario"  value="cpalol">
                                    <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i>
                                        Ingresa tu usuario</b></label>

                            </section>
                            <section>
                                <label class="label">Contraseña</label>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    <input type="password" name="usu_password" value="TTff44">
                                ...
                                @if ($errors->has('usu_password'))
                                    <span class="help-block"><strong>{{ $errors->first('usu_password') }}</strong></span>
                                @endif
                                <div class="note">
                            ...
                            <section>
                                @if ($errors->has('usu_usuario'))
                                    <span class="help-block"><strong>{{ $errors->first('usu_usuario') }}</strong></span>
                            @endif
                                <!--
